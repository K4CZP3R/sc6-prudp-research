...
const openssl = {
  ...
  PEM_write_bio_PrivateKey: function (bp, x, enc, kstr, klen, cb, u) {
    ...
    var address = Module.findExportByName(null, name);
    if (address) {
      var f = new NativeFunction(address, "int", [
        "pointer",
        "pointer",
        "pointer",
        "pointer",
...
const easy = {
  ...
  export_rsa: function (rsa) {
    ...
    if (rsa != ptr(0)) {
      ...
      if (
        openssl.PEM_write_bio_RSAPrivateKey(
          mem,
          rsa,
          ptr(0),
          ptr(0),
      ...
      try {
        Interceptor.attach(address, {
          ...
          onLeave: function (result) {
            ...
            console.log(
              utils.colors.cyan(
                hexdump(ptr(this.args[1]), { length: this.args[2].toInt32() })
              )
            );
      ...
      try {
        Interceptor.attach(address, {
          ...
          onLeave: function (result) {
            ...
            console.log(
              utils.colors.red(easy.export_pkey_from_ctx(this.args[0]))
            );
            console.log(utils.colors.cyan("Buffer in: "));
            console.log(
              utils.colors.cyan(
                hexdump(ptr(this.args[3]), { length: this.args[4].toInt32() })
              )
            );
          },
        });
      ...
      try {
        Interceptor.attach(address, {
          ...
          onLeave: function (result) {
            ...
            console.log(
              utils.colors.cyan(
                hexdump(ptr(this.args[2]), { length: result.toInt32() })
              )
            );
          },
        });
      ...
      try {
        Interceptor.attach(address, {
          ...
          onLeave: function (result) {
            ...
            console.log(
              utils.colors.blue(easy.evp_ciper_type_str(this.args[0]))
            );
            console.log(utils.colors.blue("Key:"));
            console.log(
              utils.colors.blue(hexdump(this.args[3], { length: 32 }))
            );
            console.log(utils.colors.blue("IV:"));
            console.log(
              utils.colors.blue(hexdump(this.args[4], { length: 16 }))
            );
          },
        });
      } catch (error) {
      ...
      try {
        Interceptor.attach(address, {
          ...
          onLeave: function (result) {
            ...
            console.log(
              utils.colors.cyan(
                hexdump(ptr(this.args[1]), { length: this.args[2].readUInt() })
              )
            );
          },
        });
    ...
    if (address != null) {
      ...
      Interceptor.attach(address, {
        onEnter: function (args) {
          ...
          args[1] = ptr(0);
          console.log(
            utils.colors.green("[+] Setting " + name + " to mode = " + args[1])
          );
        },
      });
    }
    ...
    if (address != null) {
      ...
      Interceptor.attach(address, {
        onLeave: function (result) {
          ...
          result.replace(1);
          console.log(
            utils.colors.green("[+] Setting " + name + " to result = " + result)
          );
        },
      });
    }
